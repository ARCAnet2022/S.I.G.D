...
include '../Modelo/AdministrativoCargarUsuario.php';

class AdministrativoCargarUsuarioController{
    
    public function getForms(){
        
        $iniciar = new AdministrativoCargarUsuario;
...
$init = new AdministrativoCargarUsuarioController;
$init->getForms();
